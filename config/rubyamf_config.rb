...
module RubyAMF
  module Configuration
        ...
        ClassMappings.register(
          :actionscript  => 'Collection',
          :ruby          => 'Collection',
          :type          => 'active_record',
          :associations  => ["collection_attributes"],
          :attributes    => ["id", "parent_id", "id_path", "children_count", "family_id", "level", "name", "description", "notes", "updated_by", "created_at", "updated_at", "ancestry"])

        ClassMappings.register(
          :actionscript  => 'CollectionAttribute',
          :ruby          => 'CollectionAttribute',
          :type          => 'active_record',
          :associations  => ["collection"],
          :attributes    => ["id", "collection_id", "attribute1", "attribute2", "attribute3", "attribute4", "street", "city", "postcode", "status", "created_at", "updated_at"])
        ...
        ClassMappings.register(
          ...
          ClassMappings.register(
            :actionscript  => 'Network',
            :ruby          => 'Network',
            :type          => 'active_record',
            :associations  => ["collection"],
            :attributes    => ["id", "collection_id", "network_address", "subnet_mask", "network_class", "description", "note", "updated_by", "created_at", "updated_at", "ancestry"])

          ClassMappings.register(
            :actionscript  => 'User',
            :ruby          => 'User',
            :type          => 'active_record',
            :attributes    => ["id", "login", "email", "crypted_password", "password_salt", "persistence_token", "single_access_token", "perishable_token", "login_count", "failed_login_count", "last_request_at", "current_login_at", "last_login_at", "current_login_ip", "last_login_ip", "created_at", "updated_at"])
        
            ClassMappings.register(
              :actionscript  => 'NetworkD',
              :ruby          => 'NetworkD',
              :type          => 'active_record',
              :attributes    => ["id", "network_address", "description", "updated_by", "created_at", "updated_at", "ancestry", "parent_id"])

              ClassMappings.register(
                :actionscript  => 'Subnet',
                :ruby          => 'Subnet',
                :type          => 'active_record',
                :attributes    => ["id", "network_address", "subnet_mask", "network_class", "description", "note", "updated_by", "created_at", "updated_at", "ancestry"])

           
           
           # ClassMappings.register(
            #  :actionscript  => 'NetworkDetail',
             # :ruby          => 'NetworkDetail',
            #  :type          => 'active_record',
            #  :attributes    => ["id", "collection_id", "network_address", "subnet_mask", "network_class", "description", "note", "updated_by", "created_at", "updated_at", "ancestry", "parent_id"])
